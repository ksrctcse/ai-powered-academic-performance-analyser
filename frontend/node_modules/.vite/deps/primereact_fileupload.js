...
import {
  PlusIcon
} from "./chunk-QJOLCQHO.js";
import {
  ProgressBar
} from "./chunk-ATKXDZTI.js";
import {
  ExclamationTriangleIcon,
  InfoCircleIcon
} from "./chunk-56HB5EGR.js";
import {
  Button
} from "./chunk-C4VJF7GN.js";
import {
  TimesIcon
} from "./chunk-RSWWY3HD.js";
import {
  TimesCircleIcon
} from "./chunk-YFWUURPO.js";
import {
  CheckIcon
} from "./chunk-AC7PFJ3S.js";
import {
  CSSTransition,
  TransitionGroup_default
} from "./chunk-BMB54NEB.js";
import "./chunk-EEUAUME7.js";
import {
  Ripple
} from "./chunk-5YMKZDFV.js";
import {
  IconBase
} from "./chunk-ICRK4TJX.js";
import "./chunk-FIJ7XCBD.js";
import "./chunk-BYVUYDSR.js";
import {
  ComponentBase,
  DomHandler,
  IconUtils,
...
var FileUpload = React3.memo(React3.forwardRef(function(inProps, ref) {
  var mergeProps = useMergeProps();
  var context = React3.useContext(PrimeReactContext);
  var props = FileUploadBase.getProps(inProps, context);
  var _React$useState = React3.useState([]), _React$useState2 = _slicedToArray2(_React$useState, 2), uploadedFilesState = _React$useState2[0], setUploadedFilesState = _React$useState2[1];
  var _React$useState3 = React3.useState([]), _React$useState4 = _slicedToArray2(_React$useState3, 2), filesState = _React$useState4[0], setFilesState = _React$useState4[1];
  var _React$useState5 = React3.useState(0), _React$useState6 = _slicedToArray2(_React$useState5, 2), progressState = _React$useState6[0], setProgressState = _React$useState6[1];
  ...
  var _React$useState9 = React3.useState(false), _React$useState10 = _slicedToArray2(_React$useState9, 2), uploadingState = _React$useState10[0], setUploadingState = _React$useState10[1];
  var metaData = {
    props,
    state: {
  ...
  var fileInputRef = React3.useRef(null);
  var messagesRef = React3.useRef(null);
  var contentRef = React3.useRef(null);
  var uploadedFileCount = React3.useRef(0);
  ...
  var createChooseButton = function createChooseButton2() {
    ...
    var label = iconOnly ? React3.createElement("span", _extends3({}, chooseButtonLabelProps, {
      dangerouslySetInnerHTML: {
        __html: "&nbsp;"
      }
    })) : React3.createElement("span", chooseButtonLabelProps, chooseButtonLabel);
    ...
    var input = React3.createElement("input", inputProps);
    ...
    var icon = _icon || React3.createElement(PlusIcon, chooseIconProps);
    ...
    return React3.createElement("span", chooseButtonProps, input, chooseIcon2, label, React3.createElement(Ripple, null));
  };
  ...
  var createFile = function createFile2(file, index, badgeOptions) {
    ...
    var preview = isImage(file) ? React3.createElement("img", _extends3({}, thumbnailProps, {
      alt: file.name
    })) : null;
    ...
    var fileName = React3.createElement("div", fileNameProps, file.name);
    var size = React3.createElement("div", fileSizeProps, formatSize(file.size));
    var contentBody = React3.createElement("div", detailsProps, React3.createElement("div", fileNameProps, " ", file.name), React3.createElement("span", fileSizeProps, formatSize(file.size)), React3.createElement(Badge, {
    ...
    var removeButton = React3.createElement("div", actionsProps, React3.createElement(Button, {
      type: "button",
      icon: props.removeIcon || React3.createElement(TimesIcon, null),
      text: true,
      rounded: true,
      severity: "danger",
    ...
    var content = React3.createElement(React3.Fragment, null, preview, contentBody, removeButton);
    ...
    return React3.createElement("div", fileProps, content);
  };
  var createFiles = function createFiles2() {
    ...
    return React3.createElement("div", null, content);
  };
  ...
  var createProgressBarContent = function createProgressBarContent2() {
    ...
    return React3.createElement(ProgressBar, {
      value: progressState,
      showValue: false,
      pt: ptm("progressbar"),
      __parentMetadata: {
  ...
  var createAdvanced = function createAdvanced2() {
    ...
    if (!props.auto) {
      ...
      var uploadIcon2 = IconUtils.getJSXIcon(uploadOptions.icon || React3.createElement(UploadIcon, uploadIconProps), _objectSpread2({}, uploadIconProps), {
        props
      });
      ...
      var cancelIcon2 = IconUtils.getJSXIcon(cancelOptions.icon || React3.createElement(TimesIcon, cancelIconProps), _objectSpread2({}, cancelIconProps), {
        props
      });
      uploadButton = React3.createElement(Button, {
        type: "button",
        label: uploadLabel,
        "aria-hidden": "true",
        icon: uploadIcon2,
      ...
      cancelButton = React3.createElement(Button, {
        type: "button",
        label: cancelLabel,
        "aria-hidden": "true",
        icon: cancelIcon2,
    ...
    var header = React3.createElement("div", buttonbarProps, chooseButton2, uploadButton, cancelButton);
    ...
    return React3.createElement("div", rootProps, header, React3.createElement("div", contentProps, progressBar, React3.createElement(Messages, {
      ref: messagesRef,
      __parentMetadata: {
        parent: metaData
      }
  ...
  var createBasic = function createBasic2() {
    ...
    var chooseLabel = chooseOptions.iconOnly ? React3.createElement("span", _extends3({}, labelProps, {
      dangerouslySetInnerHTML: {
        __html: "&nbsp;"
      }
    })) : React3.createElement("span", labelProps, chooseButtonLabel);
    var label = props.auto ? chooseLabel : React3.createElement("span", labelProps, hasFiles ? props.selectedFileLabel || filesState[0].name : chooseLabel);
    var chooseIconProps = mergeProps({
      className: cx("chooseIcon", {
        iconOnly: chooseOptions.iconOnly
      })
    }, ptm("chooseIcon"));
    var icon = chooseOptions.icon ? chooseOptions.icon : !chooseOptions.icon && (!hasFiles || props.auto) ? React3.createElement(PlusIcon, chooseIconProps) : !chooseOptions.icon && hasFiles && !props.auto && React3.createElement(UploadIcon, chooseIconProps);
    var chooseIcon2 = IconUtils.getJSXIcon(icon, _objectSpread2({}, chooseIconProps), {
      props,
      hasFiles
    });
    ...
    var input = !hasFiles && React3.createElement("input", inputProps);
    var rootProps = mergeProps({
      className: classNames(props.className, cx("root")),
      style: props.style
    }, FileUploadBase.getOtherProps(props), ptm("root"));
    ...
    return React3.createElement("div", rootProps, React3.createElement(Messages, {
      ref: messagesRef,
      pt: ptm("message"),
      __parentMetadata: {
        parent: metaData
      }
    }), React3.createElement("span", basicButtonProps, chooseIcon2, label, input, React3.createElement(Ripple, null)));
  };
  if (props.mode === "advanced") {
